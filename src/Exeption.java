public class Exeption {
    ...
    static String exKav1 = " кавычки, расставленные в выражении не соответсвуют условию или их нет!";
    static String exKav2 = " выражение должно начинаться с кавычек!";
    static String exOper1 = " знак оператора всегда должен стоять после второй кавычки!  В качестве оператора можно использовать только \"+ * - /\"";
